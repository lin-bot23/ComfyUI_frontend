...
export type GetTemplateProxyErrors = {
    ...
    404: string;
    /**
     * Internal server error (GCS fetch failure).
     */
    500: string;
    /**
...
export type GetTemplateProxyError = GetTemplateProxyErrors[keyof GetTemplateProxyErrors];
...
export type GetTemplateProxyResponse = GetTemplateProxyResponses[keyof GetTemplateProxyResponses];
